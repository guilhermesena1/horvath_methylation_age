...
source("additional_file_24_normalization.r")
...
if (file.exists("LogFile.txt")) # Added by GS
file.remove("LogFile.txt")
file.create("LogFile.txt")

DoNotProceed <- FALSE
cat(paste( "The methylation data set contains", nSamples,
           "samples (e.g. arrays) and ", nProbes, " probes."),file="LogFile.txt")
